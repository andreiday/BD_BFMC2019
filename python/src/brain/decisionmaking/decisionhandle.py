...
from src.utils.imageprocessing.move import stabilize_steering_angle
...
class DecisionHandler:
    ...
    def _updateMotionState(self):
        ...
        elif self.detected_sign == "priority" and self.canChangeState == True:
            # detect intersection
            self.stateTime = time.time()
            self.canChangeState = False

            self.timeLeft = DECISION_TIME
